...
import (
	...
	scheme "github.com/toddtreece/kubernetes-list-tests/informer/pkg/client/clientset/versioned/scheme"
...
type DashboardInterface interface {
	...
	Apply(ctx context.Context, dashboard *dashboardv1alpha1.DashboardApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Dashboard, err error)
	DashboardExpansion
}
...
func (c *dashboards) Apply(ctx context.Context, dashboard *dashboardv1alpha1.DashboardApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Dashboard, err error) {
	if dashboard == nil {
